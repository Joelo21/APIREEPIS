-- --------------------------------------------------------
-- Host:                         192.168.0.2
-- Versión del servidor:         10.3.17-MariaDB - mariadb.org binary distribution
...
-- Volcando datos para la tabla reepis.mdl_escuela: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla reepis.mdl_objetivoeducacional: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla reepis.mdl_resultadoestudiante: ~0 rows (aproximadamente)
...
-- Volcando estructura para procedimiento reepis.USP_MDL_ESCUELA_E
DELIMITER //
CREATE PROCEDURE `USP_OBJETIVOEDUCACIONAL_E`(
   IN pCod_Objetivo VARCHAR(8)
   )
BEGIN
...
-- Volcando estructura para procedimiento reepis.USP_MDL_ESCUELA_G
DELIMITER //
CREATE PROCEDURE `USP_OBJETIVOEDUCACIONAL_G`(
IN pCod_Objetivo VARCHAR(8),
IN pCod_Escuela VARCHAR(8),
IN pDescripcion VARCHAR(1024)
)
